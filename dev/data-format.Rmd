...
## What you need to know about your data set
...
Most of Alex's psychopy RSVP programs have two targets potentially, recorded on the same row of the psychopy data file. So, need to melt into separate rows while preserving trialnum.
