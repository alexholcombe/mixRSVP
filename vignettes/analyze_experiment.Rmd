...
g<-g + 
  geom_text(data=curveDfs,aes(x=-9,y=y-10, label = paste("-logLik==", round(val,1), sep = "")), parse=TRUE,hjust="left") +
  geom_text(data=curveDfs, aes(x=-7, y=y-12, label = paste("p==",round(pLRtest,3), sep="")),parse=TRUE,hjust="left")
